...
notebook_path = Path(__file__).resolve() if '__file__' in globals() else Path.cwd()
sys.path.insert(0, str(notebook_path))

#Load up the other scripts
import clean_data as clean_data
import preprocess_images as preprocess_images
import training as training
import reload_images as reload_images
import interpret_json as interpret_json
